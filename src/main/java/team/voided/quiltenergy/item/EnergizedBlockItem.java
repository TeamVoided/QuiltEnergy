...
public class EnergizedBlockItem extends BlockItem implements IEnergizedItem {
	...
	public EnergizedBlockItem(Block block, Properties properties, EnergyUnit unit, double maxCapacity) {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level world, List<Component> tooltip, TooltipFlag context) {
		String maxAmountLiteral;

		if (getMaxCapacity() > 1000 && getMaxCapacity() < 1_000_000) {
			double max = getMaxCapacity() / 1000;
		}
